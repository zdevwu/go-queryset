...
func (qs BlogQuerySet) OrCreatedAtEq(createdAt time.Time) BlogQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("created_at"), "= ?"), createdAt))
}
...
// OrDeletedAtEq is an autogenerated method
// nolint: dupl
func (qs BlogQuerySet) OrDeletedAtEq(deletedAt time.Time) BlogQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("deleted_at"), "= ?"), deletedAt))
}

// OrDeletedAtGt is an autogenerated method
// nolint: dupl
func (qs BlogQuerySet) OrDeletedAtGt(deletedAt time.Time) BlogQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("deleted_at"), "> ?"), deletedAt))
}

// OrDeletedAtGte is an autogenerated method
// nolint: dupl
func (qs BlogQuerySet) OrDeletedAtGte(deletedAt time.Time) BlogQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("deleted_at"), ">= ?"), deletedAt))
}

// OrDeletedAtIsNotNull is an autogenerated method
// nolint: dupl
func (qs BlogQuerySet) OrDeletedAtIsNotNull() BlogQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("deleted_at"), "IS NOT NULL")))
}

// OrDeletedAtIsNull is an autogenerated method
// nolint: dupl
func (qs BlogQuerySet) OrDeletedAtIsNull() BlogQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("deleted_at"), "IS NULL")))
}

// OrDeletedAtLt is an autogenerated method
// nolint: dupl
func (qs BlogQuerySet) OrDeletedAtLt(deletedAt time.Time) BlogQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("deleted_at"), "< ?"), deletedAt))
}

// OrDeletedAtLte is an autogenerated method
// nolint: dupl
func (qs BlogQuerySet) OrDeletedAtLte(deletedAt time.Time) BlogQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("deleted_at"), "<= ?"), deletedAt))
}

// OrDeletedAtNe is an autogenerated method
// nolint: dupl
func (qs BlogQuerySet) OrDeletedAtNe(deletedAt time.Time) BlogQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("deleted_at"), "!= ?"), deletedAt))
}
...
func (qs BlogQuerySet) OrIDEq(ID uint) BlogQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("id"), "= ?"), ID))
}
...
func (qs BlogQuerySet) OrIDIn(ID ...uint) BlogQuerySet {
	...
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s (?)", qs.db.Dialect().Quote("id"), "IN"), ID))
}
...
func (qs BlogQuerySet) OrIDNotIn(ID ...uint) BlogQuerySet {
	...
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s (?)", qs.db.Dialect().Quote("id"), "NOT IN"), ID))
}

// OrNameEq is an autogenerated method
// nolint: dupl
func (qs BlogQuerySet) OrNameEq(name string) BlogQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("myname"), "= ?"), name))
}
...
func (qs BlogQuerySet) OrNameIn(name ...string) BlogQuerySet {
	...
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s (?)", qs.db.Dialect().Quote("myname"), "IN"), name))
}

// OrNameLike is an autogenerated method
// nolint: dupl
func (qs BlogQuerySet) OrNameLike(name string) BlogQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("myname"), "LIKE ?"), name))
}
...
func (qs BlogQuerySet) OrNameNotIn(name ...string) BlogQuerySet {
	...
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s (?)", qs.db.Dialect().Quote("myname"), "NOT IN"), name))
}

// OrNameNotlike is an autogenerated method
// nolint: dupl
func (qs BlogQuerySet) OrNameNotlike(name string) BlogQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("myname"), "NOT LIKE ?"), name))
}

// OrUpdatedAtEq is an autogenerated method
// nolint: dupl
func (qs BlogQuerySet) OrUpdatedAtEq(updatedAt time.Time) BlogQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("updated_at"), "= ?"), updatedAt))
}
...
func (qs CheckReservedKeywordsQuerySet) OrStructEq(structValue int) CheckReservedKeywordsQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("struct"), "= ?"), structValue))
}
...
func (qs CheckReservedKeywordsQuerySet) OrStructIn(structValue ...int) CheckReservedKeywordsQuerySet {
	...
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s (?)", qs.db.Dialect().Quote("struct"), "IN"), structValue))
}
...
func (qs CheckReservedKeywordsQuerySet) OrStructNotIn(structValue ...int) CheckReservedKeywordsQuerySet {
	...
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s (?)", qs.db.Dialect().Quote("struct"), "NOT IN"), structValue))
}
...
func (qs CheckReservedKeywordsQuerySet) OrTypeEq(typeValue string) CheckReservedKeywordsQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("type"), "= ?"), typeValue))
}
...
func (qs CheckReservedKeywordsQuerySet) OrTypeIn(typeValue ...string) CheckReservedKeywordsQuerySet {
	...
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s (?)", qs.db.Dialect().Quote("type"), "IN"), typeValue))
}
...
func (qs CheckReservedKeywordsQuerySet) OrTypeLike(typeValue string) CheckReservedKeywordsQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("type"), "LIKE ?"), typeValue))
}
...
func (qs CheckReservedKeywordsQuerySet) OrTypeNotIn(typeValue ...string) CheckReservedKeywordsQuerySet {
	...
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s (?)", qs.db.Dialect().Quote("type"), "NOT IN"), typeValue))
}
...
func (qs CheckReservedKeywordsQuerySet) OrTypeNotlike(typeValue string) CheckReservedKeywordsQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("type"), "NOT LIKE ?"), typeValue))
}
...
func (qs PostQuerySet) OrBlogIsNotNull() PostQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("blog"), "IS NOT NULL")))
}

// OrBlogIsNull is an autogenerated method
// nolint: dupl
func (qs PostQuerySet) OrBlogIsNull() PostQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("blog"), "IS NULL")))
}
...
// OrDeletedAtEq is an autogenerated method
// nolint: dupl
func (qs PostQuerySet) OrDeletedAtEq(deletedAt time.Time) PostQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("deleted_at"), "= ?"), deletedAt))
}

// OrDeletedAtGt is an autogenerated method
// nolint: dupl
func (qs PostQuerySet) OrDeletedAtGt(deletedAt time.Time) PostQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("deleted_at"), "> ?"), deletedAt))
}

// OrDeletedAtGte is an autogenerated method
// nolint: dupl
func (qs PostQuerySet) OrDeletedAtGte(deletedAt time.Time) PostQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("deleted_at"), ">= ?"), deletedAt))
}

// OrDeletedAtIsNotNull is an autogenerated method
// nolint: dupl
func (qs PostQuerySet) OrDeletedAtIsNotNull() PostQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("deleted_at"), "IS NOT NULL")))
}

// OrDeletedAtIsNull is an autogenerated method
// nolint: dupl
func (qs PostQuerySet) OrDeletedAtIsNull() PostQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("deleted_at"), "IS NULL")))
}

// OrDeletedAtLt is an autogenerated method
// nolint: dupl
func (qs PostQuerySet) OrDeletedAtLt(deletedAt time.Time) PostQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("deleted_at"), "< ?"), deletedAt))
}

// OrDeletedAtLte is an autogenerated method
// nolint: dupl
func (qs PostQuerySet) OrDeletedAtLte(deletedAt time.Time) PostQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("deleted_at"), "<= ?"), deletedAt))
}

// OrDeletedAtNe is an autogenerated method
// nolint: dupl
func (qs PostQuerySet) OrDeletedAtNe(deletedAt time.Time) PostQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("deleted_at"), "!= ?"), deletedAt))
}
...
func (qs PostQuerySet) OrStrEq(str tmp.StringDef) PostQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("str"), "= ?"), str))
}
...
func (qs PostQuerySet) OrStrIn(str ...tmp.StringDef) PostQuerySet {
	...
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s (?)", qs.db.Dialect().Quote("str"), "IN"), str))
}

// OrStrLike is an autogenerated method
// nolint: dupl
func (qs PostQuerySet) OrStrLike(str tmp.StringDef) PostQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("str"), "LIKE ?"), str))
}
...
func (qs PostQuerySet) OrStrNotIn(str ...tmp.StringDef) PostQuerySet {
	...
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s (?)", qs.db.Dialect().Quote("str"), "NOT IN"), str))
}

// OrStrNotlike is an autogenerated method
// nolint: dupl
func (qs PostQuerySet) OrStrNotlike(str tmp.StringDef) PostQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("str"), "NOT LIKE ?"), str))
}

// OrTitleEq is an autogenerated method
// nolint: dupl
func (qs PostQuerySet) OrTitleEq(title string) PostQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("title"), "= ?"), title))
}
...
func (qs PostQuerySet) OrTitleIn(title ...string) PostQuerySet {
	...
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s (?)", qs.db.Dialect().Quote("title"), "IN"), title))
}

// OrTitleIsNotNull is an autogenerated method
// nolint: dupl
func (qs PostQuerySet) OrTitleIsNotNull() PostQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("title"), "IS NOT NULL")))
}

// OrTitleIsNull is an autogenerated method
// nolint: dupl
func (qs PostQuerySet) OrTitleIsNull() PostQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("title"), "IS NULL")))
}

// OrTitleLike is an autogenerated method
// nolint: dupl
func (qs PostQuerySet) OrTitleLike(title string) PostQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("title"), "LIKE ?"), title))
}
...
func (qs PostQuerySet) OrTitleNotIn(title ...string) PostQuerySet {
	...
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s (?)", qs.db.Dialect().Quote("title"), "NOT IN"), title))
}

// OrTitleNotlike is an autogenerated method
// nolint: dupl
func (qs PostQuerySet) OrTitleNotlike(title string) PostQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("title"), "NOT LIKE ?"), title))
}
...
// OrDeletedAtEq is an autogenerated method
// nolint: dupl
func (qs UserQuerySet) OrDeletedAtEq(deletedAt time.Time) UserQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("deleted_at"), "= ?"), deletedAt))
}

// OrDeletedAtGt is an autogenerated method
// nolint: dupl
func (qs UserQuerySet) OrDeletedAtGt(deletedAt time.Time) UserQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("deleted_at"), "> ?"), deletedAt))
}

// OrDeletedAtGte is an autogenerated method
// nolint: dupl
func (qs UserQuerySet) OrDeletedAtGte(deletedAt time.Time) UserQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("deleted_at"), ">= ?"), deletedAt))
}

// OrDeletedAtIsNotNull is an autogenerated method
// nolint: dupl
func (qs UserQuerySet) OrDeletedAtIsNotNull() UserQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("deleted_at"), "IS NOT NULL")))
}

// OrDeletedAtIsNull is an autogenerated method
// nolint: dupl
func (qs UserQuerySet) OrDeletedAtIsNull() UserQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("deleted_at"), "IS NULL")))
}

// OrDeletedAtLt is an autogenerated method
// nolint: dupl
func (qs UserQuerySet) OrDeletedAtLt(deletedAt time.Time) UserQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("deleted_at"), "< ?"), deletedAt))
}

// OrDeletedAtLte is an autogenerated method
// nolint: dupl
func (qs UserQuerySet) OrDeletedAtLte(deletedAt time.Time) UserQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("deleted_at"), "<= ?"), deletedAt))
}

// OrDeletedAtNe is an autogenerated method
// nolint: dupl
func (qs UserQuerySet) OrDeletedAtNe(deletedAt time.Time) UserQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("deleted_at"), "!= ?"), deletedAt))
}
...
func (qs UserQuerySet) OrEmailEq(email string) UserQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("email"), "= ?"), email))
}
...
func (qs UserQuerySet) OrEmailIn(email ...string) UserQuerySet {
	...
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s (?)", qs.db.Dialect().Quote("email"), "IN"), email))
}

// OrEmailLike is an autogenerated method
// nolint: dupl
func (qs UserQuerySet) OrEmailLike(email string) UserQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("email"), "LIKE ?"), email))
}
...
func (qs UserQuerySet) OrEmailNotIn(email ...string) UserQuerySet {
	...
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s (?)", qs.db.Dialect().Quote("email"), "NOT IN"), email))
}

// OrEmailNotlike is an autogenerated method
// nolint: dupl
func (qs UserQuerySet) OrEmailNotlike(email string) UserQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("email"), "NOT LIKE ?"), email))
}
...
func (qs UserQuerySet) OrNameEq(name string) UserQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("name"), "= ?"), name))
}
...
func (qs UserQuerySet) OrNameIn(name ...string) UserQuerySet {
	...
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s (?)", qs.db.Dialect().Quote("name"), "IN"), name))
}

// OrNameLike is an autogenerated method
// nolint: dupl
func (qs UserQuerySet) OrNameLike(name string) UserQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("name"), "LIKE ?"), name))
}
...
func (qs UserQuerySet) OrNameNotIn(name ...string) UserQuerySet {
	...
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s (?)", qs.db.Dialect().Quote("name"), "NOT IN"), name))
}

// OrNameNotlike is an autogenerated method
// nolint: dupl
func (qs UserQuerySet) OrNameNotlike(name string) UserQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("name"), "NOT LIKE ?"), name))
}

// OrSurnameEq is an autogenerated method
// nolint: dupl
func (qs UserQuerySet) OrSurnameEq(surname string) UserQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("user_surname"), "= ?"), surname))
}
...
func (qs UserQuerySet) OrSurnameIn(surname ...string) UserQuerySet {
	...
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s (?)", qs.db.Dialect().Quote("user_surname"), "IN"), surname))
}

// OrSurnameIsNotNull is an autogenerated method
// nolint: dupl
func (qs UserQuerySet) OrSurnameIsNotNull() UserQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("user_surname"), "IS NOT NULL")))
}

// OrSurnameIsNull is an autogenerated method
// nolint: dupl
func (qs UserQuerySet) OrSurnameIsNull() UserQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("user_surname"), "IS NULL")))
}

// OrSurnameLike is an autogenerated method
// nolint: dupl
func (qs UserQuerySet) OrSurnameLike(surname string) UserQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("user_surname"), "LIKE ?"), surname))
}
...
func (qs UserQuerySet) OrSurnameNotIn(surname ...string) UserQuerySet {
	...
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s (?)", qs.db.Dialect().Quote("user_surname"), "NOT IN"), surname))
}

// OrSurnameNotlike is an autogenerated method
// nolint: dupl
func (qs UserQuerySet) OrSurnameNotlike(surname string) UserQuerySet {
	return qs.w(qs.db.Or(fmt.Sprintf("%s %s", qs.db.Dialect().Quote("user_surname"), "NOT LIKE ?"), surname))
}
